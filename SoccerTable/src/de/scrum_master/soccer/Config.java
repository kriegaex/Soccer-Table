...
public class Config
{
	...
	private void initialise_Primera_Division_2006_07() {
		...
		groups.add(Group.parseCrossTable("PD_2006_07", "Primera División 2006/07", rawData, PRIMERA_DIVISION.comparator));
	}
	...
	private void initialise_Primera_Division_2007_08() {
		...
		groups.add(Group.parseCrossTable("PD_2007_08", "Primera División 2007/08", rawData, PRIMERA_DIVISION.comparator));
	}
	...
	private void initialise_Primera_Division_2008_09() {
		...
		groups.add(Group.parseCrossTable("PD_2008_09", "Primera División 2008/09", rawData, PRIMERA_DIVISION.comparator));
	}
	...
	private void initialise_Primera_Division_2009_10() {
		...
		groups.add(Group.parseCrossTable("PD_2009_10", "Primera División 2009/10", rawData, PRIMERA_DIVISION.comparator));
	}
	...
	private void initialise_Primera_Division_2010_11() {
		...
		groups.add(Group.parseCrossTable("PD_2010_11", "Primera División 2010/11", rawData, PRIMERA_DIVISION.comparator));
	}
	...
	private void initialise_Primera_Division_2011_12() {
		...
		groups.add(Group.parseCrossTable("PD_2011_12", "Primera División 2011/12", rawData, PRIMERA_DIVISION.comparator));
	}

	private void initialise_Euro_2012_Group_A() {
		Group group = new Group("A", "Gruppe A", EURO_2012.comparator);
		groups.add(group);
	...
	private void initialise_Euro_2012_Group_B() {
		Group group = new Group("B", "Gruppe B", EURO_2012.comparator);
		groups.add(group);
	...
	private void initialise_Euro_2012_Group_C() {
		Group group = new Group("C", "Gruppe C", EURO_2012.comparator);
		groups.add(group);
	...
	private void initialise_Euro_2012_Group_D() {
		Group group = new Group("D", "Gruppe D", EURO_2012.comparator);
		groups.add(group);
	...
	private void initialise_Dummy_1() {
		Group group = new Group("X1", "Gruppe Dummy1", EURO_2012.comparator);
		groups.add(group);
	...
	private void initialise_Dummy_2() {
		Group group = new Group("X2", "Gruppe Dummy2", EURO_2012.comparator);
		groups.add(group);
	...
	private void initialise_Dummy_3() {
		Group group = new Group("X3", "Gruppe Dummy3", EURO_2012.comparator);
		groups.add(group);
	...
	private void initialise_Dummy_4() {
		Group group = new Group("X4", "Gruppe Dummy4", EURO_2012.comparator);
		groups.add(group);
